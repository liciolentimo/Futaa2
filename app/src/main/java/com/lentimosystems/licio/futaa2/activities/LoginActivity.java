...
//    public TextView mTxtSignUpText;
//    public TextView mTxtForgotPassword;
...
//        mTxtSignUpText = (TextView)findViewById(R.id.txtSignUpText);
    ...
    private void loginwithPassword() {
        ...
        if (email.equals("")) {
            mTxtEmail.setError("Please enter your email");
            return;
        }
        mAuthProgressDialog.show();
        if (password.equals("")) {
            mTxtPassword.setError("Password cannot be blank");
            return;
        }
